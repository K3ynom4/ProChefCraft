...
public class SirfryList extends javax.swing.JFrame {
    private List<FoodRecipe> recipe;
    private DefaultTableModel sirfryModel;
    ...
    public SirfryList() {
        ...
        sirfryModel = (DefaultTableModel)SirfryList.getModel();
        loadDataFromFile("data/Sirfry.txt");
    }
    ...
    private void initComponents() {
        ...
        SirfryList = new javax.swing.JTable();
        ...
        jLabel1.setText("Danh sách các món xào");

        SirfryList.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Tên món ăn", "Nguyên Liệu", "Cách Nấu", "Thời gian nấu"
            }
        ));
        jScrollPane1.setViewportView(SirfryList);
    ...
    private void addMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addMouseClicked
        AddSirfry addrecipe = new AddSirfry( this, rootPaneCheckingEnabled); 
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        int removeId = SirfryList.getSelectedRow();
        if(removeId == -1){
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        selectedIndex = SirfryList.getSelectedRow();
        if(selectedIndex == -1){
            ...
            EditSirfry edit = new EditSirfry(this,rootPaneCheckingEnabled);            
    ...
    private void showData() {
        sirfryModel.setRowCount(0);
        for(FoodRecipe x : recipe){
            sirfryModel.addRow(new Object[]{x.getName(),x.getIngredients(),
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SirfryList().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTable SirfryList;
