...
public class AddVegetarian extends javax.swing.JDialog {
//    public String fileName;
//    public boolean check = false;
    private VegetarianList home;
    
    public AddVegetarian(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
...
//        AddNewRecipe add = new AddNewRecipe();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddVegetarian dialog = new AddVegetarian(new javax.swing.JFrame(),true);
