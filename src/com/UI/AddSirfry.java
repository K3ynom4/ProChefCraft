...
public class AddSirfry extends javax.swing.JDialog {

    private SirfryList home;
    
    public AddSirfry(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddSirfry dialog = new AddSirfry(new javax.swing.JFrame(),true);
