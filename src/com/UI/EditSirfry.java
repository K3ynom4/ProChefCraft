...
public class EditSirfry extends javax.swing.JDialog {
//    public String fileName;
//    public boolean check = false;
    private SirfryList home;
    
    public EditSirfry(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
        home = (SirfryList)parent;
...
//    }
    ...
    private void backMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_backMouseClicked
        SirfryList main = new SirfryList();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditSirfry dialog = new EditSirfry(new javax.swing.JFrame(),true);
