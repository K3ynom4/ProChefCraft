...
public class EditSteamed extends javax.swing.JDialog {
//    public String fileName;
//    public boolean check = false;
    private SteamedList home;
    
    public EditSteamed(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
        home = (SteamedList)parent;
...
//    }
    ...
    private void backMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_backMouseClicked
        SteamedList main = new SteamedList();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditSteamed dialog = new EditSteamed(new javax.swing.JFrame(),true);
