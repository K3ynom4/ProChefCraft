...
public class EditMonKho extends javax.swing.JDialog {

    private MonKhoList home;
    
    public EditMonKho(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditMonKho dialog = new EditMonKho(new javax.swing.JFrame(),true);
