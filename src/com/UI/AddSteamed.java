...
public class AddSteamed extends javax.swing.JDialog {
//    public String fileName;
//    public boolean check = false;
    private SteamedList home;
    
    public AddSteamed(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
...
//        AddNewRecipe add = new AddNewRecipe();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddSteamed dialog = new AddSteamed(new javax.swing.JFrame(),true);
