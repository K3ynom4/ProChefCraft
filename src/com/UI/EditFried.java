...
public class EditFried extends javax.swing.JDialog {
//    public String fileName;
//    public boolean check = false;
    private FriedList home;
    
    public EditFried(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
        home = (FriedList)parent;
...
//    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditFried dialog = new EditFried(new javax.swing.JFrame(),true);
