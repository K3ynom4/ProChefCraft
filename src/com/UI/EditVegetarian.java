...
public class EditVegetarian extends javax.swing.JDialog {
//    public String fileName;
//    public boolean check = false;
    private VegetarianList home;
    
    public EditVegetarian(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
        home = (VegetarianList)parent;
...
//    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Chỉnh sửa công thức");
    ...
    private void backMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_backMouseClicked
        VegetarianList main = new VegetarianList();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditVegetarian dialog = new EditVegetarian(new javax.swing.JFrame(),true);
    ...
    public void setEditData(FoodRecipe f){
        nameF.setText(f.getName());
        ingredientF.setText(f.getIngredients());
        cookF.setText(f.getInstructions());
        timecookF.setText(f.getCookingTime());
    }
